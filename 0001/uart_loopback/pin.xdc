...
set_property -dict {PACKAGE_PIN L16 IOSTANDARD LVCMOS33} [get_ports {uart_rxd}];  #GPIO[3]
set_property -dict {PACKAGE_PIN L17 IOSTANDARD LVCMOS33} [get_ports {uart_txd}];  #GPIO[4]
